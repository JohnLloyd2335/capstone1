  ...
  <section class="main-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Archive</span>
      </div>
    ...
    <div class="main-content mx-2 px-2">
      ...
      <div class="container-fluid">
        <div class="row ">
          <div class="col d-flex align-items-center justify-content-end pr-5">
            ...
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exportArchiveImmunization" ><i class="fas fa-file-download"></i></button>
      ...
      <table id="immunization_list" class="table table-striped table-bordered">  
        ...
        <tbody >
            <?php  
            $selectAllImmunization = $sqlConn->query("SELECT * FROM archive INNER JOIN immunization_category ON archive.immunization_category_id = immunization_category.immunization_category_id ORDER BY date_recorded DESC;");
            ...
            <tr>
                ...
                <td class="d-flex" style="gap: 10px;">
                    <button class="btn btn-success btn-sm" data-target="#viewImmunizationModal<?php echo $row['archive_id']; ?>" data-toggle="modal">
                        <i class="fas fa-eye"></i>
                    </button>

                    <button class="btn btn-info btn-sm" data-target="#unArchiveImmunizationModal<?php echo $row['archive_id']; ?>" data-toggle="modal">
                    <i class="fas fa-box-open"></i>
                    </button>

                    <button class="btn btn-danger btn-sm" data-target="#deleteImmunizationModal<?php echo $row['archive_id']; ?>" data-toggle="modal">
...
<!-- Modals -->
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
                  ...
                  <div class="container-fluid my-2 mx-2">
                    ...
                    <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <?php
                              $query = "SELECT * FROM vaccine_category Order by vaccine_category_id";
                            ...
                            <select name="immunization_category_id" id="immunization_category_name" class="form-control" onchange="FetchVaccine(this.value)" required>
                              <option>Select Vaccine Category</option>
                              <?php
            ...
            <div class="modal-footer">
                <input type="hidden" name="added_by" value="Nurse/MidWife">
                <button type="submit" class="btn btn-primary" name="add_immunization_nurse">Save</button>
    ...
    $selectAllImmunization = $sqlConn->query("SELECT * FROM archive INNER JOIN immunization_category ON archive.immunization_category_id = immunization_category.immunization_category_id ORDER BY date_recorded DESC;");
    while($row = mysqli_fetch_array($selectAllImmunization)):?>
    <div class="modal fade" id="viewImmunizationModal<?php echo $row['archive_id']; ?>">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
    ...
    <!-- Unarchived Immunization Modal -->
    <?php 
    $selectAllImmunization = $sqlConn->query("SELECT * FROM archive INNER JOIN immunization_category ON archive.immunization_category_id = immunization_category.immunization_category_id ORDER BY date_recorded DESC;");
    while($row = mysqli_fetch_array($selectAllImmunization)):?>
    <div class="modal fade" id="unArchiveImmunizationModal<?php echo $row['archive_id']; ?>">
      <div class="modal-dialog">
        <div class="modal-content">
        
            <!-- Modal Header -->
            <div class="modal-header">
              <h3 class="modal-title font-weight-light">Unarchived Immunization</h3>
              <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
              ...
              <div class="container-fluid">
                  <div class="row">
                    <div class="col d-flex justify-content-center">
                      <i class="fas fa-box-open h1 border border-info border-5 text-info bg-light rounded-circle p-4"></i>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col text-center">
                      <h3>Are you sure you want to unarchive this Record?</h3>
                    </div>
                  </div>
              </div>
              <form action="../crud.php" method="POST">
                        <input type="hidden" class="form-control" name="archive_id" value="<?php echo $row['archive_id'] ?>" required>

                         <input type="hidden" class="form-control" name="immunization_id" value="<?php echo $row['immunization_id'] ?>" required>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-info" name="unarchive_immunization_nurse">Yes</button>
              </form>
    ...
    <?php endwhile; ?>
    <!-- Unarchived Immnization Modal -->

    <!-- Delete Immunization Modal -->
    <?php 
    $selectAllImmunization = $sqlConn->query("SELECT * FROM archive INNER JOIN immunization_category ON archive.immunization_category_id = immunization_category.immunization_category_id ORDER BY date_recorded DESC;");
    while($row = mysqli_fetch_array($selectAllImmunization)):?>
    <div class="modal fade" id="deleteImmunizationModal<?php echo $row['archive_id']; ?>">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col text-center">
                        <h3>Are you sure you want to permanently delete this Record?</h3>
                        </div>
                    </div>
                </div>
            ...
            <!-- Modal footer -->
            <div class="modal-footer">
                <button type="submit" class="btn btn-danger" name="delete_immunization_nurse">Yes</button>
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            </div>
            </form>
    ...
    <!-- Export Archive Immunization Modal -->

    <div class="modal fade" id="exportArchiveImmunization">
              <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="container-fluid">
                        <form action="../crud.php" method="POST">
                          ...
                          <div class="row mt-2">
                            <div class="col text-center">
                              <h5 class="font-weight-light">Enter password to export table</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" name="export_archive_immunization_as_excel_nurse">Confirm</button>
                        </form>
          ...
          <!-- Export Immunization Backup Modal -->
