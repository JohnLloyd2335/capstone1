  ...
  <section class="main-section">
    ...
    <div class="main-content mx-2 px-2">
      <div class="container-fluid">
        <div class="row d-flex p-2 justify-content-start">
            ...
            <div class="col d-flex align=items-center justify-content-end pr-5">
              ...
              <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exportImmunization"><i class="fas fa-file-download"></i></button>
      ...
      <table id="immunization_list" class="table table-striped table-bordered">  
        ...
        <tbody >
            <?php  
            $selectAllImmunization = $sqlConn->query("SELECT * FROM immunization INNER JOIN immunization_category ON immunization.immunization_category_id = immunization_category.immunization_category_id WHERE immunization.immunization_category_id=1 ORDER BY date_recorded DESC;");
...
<!-- Modals -->
                      ...
                      <div class="col-md-4">
                          <div class="form-group">
                              ...
                              <div class="wrapper" style="width:200px;height:80px;">
                                ...
                                <option value="<?php echo "0 month old" ?>"><?php echo "0 month old"; ?></option>
                                  <?php 
                                  $i = 1;
                                  while($i < 10):
                                  ?>
                                  <option value="<?php echo $i.' months old' ?>"><?php echo $i." months old" ?></option>
                                  <?php $i++; endwhile ?>
                                  <option value="<?php echo "1 year old"; ?>"><?php echo "1 year old" ?></option>
                                </select>
                              </div>
                          </div>
                      </div>
                  ...
                  <div class="container-fluid my-2 mx-2">
                    ...
                    <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <?php
                              $query = "SELECT * FROM vaccine_category WHERE vaccine_category_id=1 Order by vaccine_category_id";
      ...
      <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-info" name="archive_immunization_nurse">Yes</button>
              </form>
    ...
    <div class="modal fade" id="editImmunizationModal<?php echo $row['immunization_id']; ?>">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <!-- Modal footer -->
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary" name="edit_immunization_nurse">Save</button>
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            </div>
            </form>
    ...
    <!-- Edit Immunization Modal -->
        ...
        <!-- Export Immunization Modal -->

        <div class="modal fade" id="exportImmunization">
              <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" name="export_immunization_as_excel_nurse">Confirm</button>
                        </form>
