...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>E-TUROK | SECOND DOSE IMMUNIZATION</title>
  ...
  <section class="main-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Second Dose Immunization</span>
      </div>
    ...
    <div class="main-content mx-2 px-2">
      ...
      <table id="second_dose_infant_immunization_list" class="table table-striped table-bordered">  
        ...
        <tbody >
            <?php  
            $selectAllImmunization = $sqlConn->query("SELECT * FROM immunization INNER JOIN immunization_category ON immunization.immunization_category_id = immunization_category.immunization_category_id WHERE doses >= 2 AND doses_received =1 AND immunization.immunization_category_id=1;");
        ...
        $(document).ready(function(){  
            $('#second_dose_infant_immunization_list').DataTable();  
        });  
        </script>
      </div>
      <!-- Infant 2nd Dose -->
      ...
      <table id="second_dose_school_age_immunization_list" class="table table-striped table-bordered">  
        <thead class="text-center">  
            <tr> 
                <th>Firstname</th> 
                <th>Middlename</th> 
        ...
        <tbody >
            <?php  
            $selectAllImmunization = $sqlConn->query("SELECT * FROM immunization INNER JOIN immunization_category ON immunization.immunization_category_id = immunization_category.immunization_category_id WHERE doses >= 2 AND doses_received =1 AND immunization.immunization_category_id=2;");
            while($row = mysqli_fetch_array($selectAllImmunization)):?>
            <tr>
                <td><?php echo $row['first_name']; ?></td>
                <td><?php echo $row['middle_name']; ?></td>
        ...
        <script>  
        $(document).ready(function(){  
            $('#second_dose_school_age_immunization_list').DataTable();  
        });  
        </script>
      </div>
      <!-- School Age Chilren 2nd Dose -->
      ...
      <table id="second_dose_pregnant_immunization_list" class="table table-striped table-bordered">  
        <thead class="text-center">  
            <tr> 
            <th>Firstname</th> 
                <th>Middlename</th> 
        ...
        <tbody >
            <?php  
           $selectAllImmunization = $sqlConn->query("SELECT * FROM immunization INNER JOIN immunization_category ON immunization.immunization_category_id = immunization_category.immunization_category_id WHERE doses >= 2 AND doses_received =1 AND immunization.immunization_category_id=3;");
            while($row = mysqli_fetch_array($selectAllImmunization)):?>
            <tr>
                <td><?php echo $row['first_name']; ?></td>
                <td><?php echo $row['middle_name']; ?></td>
        ...
        <script>  
        $(document).ready(function(){  
            $('#second_dose_pregnant_immunization_list').DataTable();  
        });  
        </script>
      </div>
      <!-- Pregnant 2nd Dose -->
      ...
      <table id="second_dose_adult_immunization_list" class="table table-striped table-bordered">  
        <thead class="text-center">  
            <tr> 
                <th>Firstname</th> 
                <th>Middlename</th> 
        ...
        <tbody >
            <?php  
            $selectAllImmunization = $sqlConn->query("SELECT * FROM immunization INNER JOIN immunization_category ON immunization.immunization_category_id = immunization_category.immunization_category_id WHERE doses >= 2 AND doses_received =1 AND immunization.immunization_category_id=4;");
            while($row = mysqli_fetch_array($selectAllImmunization)):?>
            <tr>
                <td><?php echo $row['first_name']; ?></td>
                <td><?php echo $row['middle_name']; ?></td>
        ...
        <script>  
        $(document).ready(function(){  
            $('#second_dose_adult_immunization_list').DataTable();  
        });  
        </script>
      </div>
      <!-- Adult 2nd Dose -->
      ...
      <table id="second_dose_senior_immunization_list" class="table table-striped table-bordered">  
        <thead class="text-center">  
            <tr> 
                <th>Firstname</th> 
                <th>Middlename</th> 
        ...
        <tbody >
            <?php  
            $selectAllImmunization = $sqlConn->query("SELECT * FROM immunization INNER JOIN immunization_category ON immunization.immunization_category_id = immunization_category.immunization_category_id WHERE doses >= 2 AND doses_received =1 AND immunization.immunization_category_id=5;");
            while($row = mysqli_fetch_array($selectAllImmunization)):?>
            <tr>
            <td><?php echo $row['first_name']; ?></td>
                <td><?php echo $row['middle_name']; ?></td>
        ...
        <script>  
        $(document).ready(function(){  
            $('#second_dose_senior_immunization_list').DataTable();  
        });  
        </script>
      </div>
      <!-- Senior Citizen 2nd Dose -->
    ...
    <div class="modal fade" id="editImmunizationModal<?php echo $row['immunization_id']; ?>">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                ?>
                                <label>Second Dose Schedule</label>
                                <input type="date" name="second_dose_schedule" min="<?php echo $date; ?>" class="form-control" value="<?php echo $row['second_dose_schedule']; ?>">
                            </div>
                        </div>
            ...
            <!-- Modal footer -->
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary" name="edit_second_dose">Save</button>
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            </div>
            </form>
    ...
    <div class="modal fade" id="SMSImmunizationModal<?php echo $row['immunization_id']; ?>">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
              ...
              <form action="../crud.php" method="post">
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                          <label>Message</label>
                          <textarea cols="30" rows="10" name="message" class="form-control" style="resize:none;" name="message">RHU Pila Second Dose Schedule: <?php echo $row['second_dose_schedule']; ?>
                          </textarea>
                        </div>
            ...
            <!-- Modal footer -->
            <div class="modal-footer">
                <button type="submit" name="send_sms_second_dose" class="btn btn-primary">Send</button>
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                </form>
            </div>
