  ...
  <section class="main-section">
    ...
    <div class="main-content mx-2 px-2">
      ...
      <table id="user_list" class="table table-striped table-bordered">  
        ...
        <tbody >
            <?php  
            $selectBHWUser = $sqlConn->query("SELECT * FROM users INNER JOIN user_category ON users.user_id = user_category.user_id WHERE user_type='Barangay Health Worker';");
            while($row = mysqli_fetch_array($selectBHWUser)):?>
            <tr>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary" name="add_bhw_user">Save</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
              <form action="../crud.php" method="POST">
                ...
                <button type="submit" class="btn btn-danger" name="delete_bhw_user">Yes</button>
              </form>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <form action="../crud.php" method="POST">
            ...
            <!-- Modal footer -->
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary" name="edit_bhw_user">Save</button>
