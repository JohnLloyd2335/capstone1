  ...
  <section class="main-section">
    ...
    <div class="main-content mx-2 px-2">
      ...
      <table id="immunization_list" class="table table-striped table-bordered">  
        ...
        <tbody >
            <?php  
            $selectAllImmunization = $sqlConn->query("SELECT * FROM immunization INNER JOIN immunization_category ON immunization.immunization_category_id = immunization_category.immunization_category_id WHERE immunization.immunization_category_id = 2 ORDER BY date_recorded DESC;");
