  ...
  <section class="main-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Immunization</span>
      </div>
    ...
    <div class="main-content mx-2 px-2">
      ...
      <table id="immunization_list" class="table table-striped table-bordered">  
        ...
        <tbody >
            <?php  
            $selectAllImmunization = $sqlConn->query("SELECT * FROM immunization INNER JOIN immunization_category ON immunization.immunization_category_id = immunization_category.immunization_category_id WHERE immunization.immunization_category_id = 4 ORDER BY date_recorded DESC;");
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                        ...
                        <form action="../crud.php" method="POST">
                          ...
                          <div class="row mt-2">
                            <div class="col text-center">
                              ...
                              <input type="hidden" name="correct_password" value="<?php echo $_SESSION['admin-logged-in-password']; ?>">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" name="export_immunization_as_excel_admin">Confirm</button>
                        </form>
